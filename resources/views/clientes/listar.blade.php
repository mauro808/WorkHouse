...
<div class="row w-30" style="padding-left:60px; "> 
    <div class="col-lg-10 p-5 m-2" align="left" >
        <h2 class="text-lucida"><strong>Clientes</strong></h2>
    </div>
</div class="">
 <div align="right">
    <a class="btn btn-dark btn-lg active" href="{{ route('agregarCliente')}}">
...
</svg><strong> Agregar Cliente</strong></a>
    </div>
  ...
  <path d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5zM4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0z"/>
                            ...
                            <a class="btn btn-light" href="{{ route('cliente.editar', $cliente) }}"style="margin-left: 10px">
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
      ...
      <div align="right">
         <a href="{{ route('PdfClientes') }}" target="_blank" class="btn btn-lg active btn-dark">
