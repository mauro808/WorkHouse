            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div align="right">
                        <a href="" target="_blank" class="btn btn-sm active btn-dark" >
                ...
                <div class="card-footer text-muted">
                    <a href="{{route('venta.index')}}" class="btn btn-dark float-right btn-lg"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-skip-backward-fill" viewBox="0 0 16 16">
