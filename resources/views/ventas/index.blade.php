...
<div class="row w-30" style="padding-left:60px; "> 
   ...
   <div align="right">
        <a class="btn btn-dark btn-lg active"   href="{{ route('ventas.create')}}">
            ...
            @foreach($ventas as $venta)
                <tr>
                    ...
                    <td>{{$usuario->nombreUsuario}}</td>
                        ...
                        <a class="btn btn-dark" href="{{ route('ventas.show', $venta) }}" style="margin-left: 10px">
...
function anulada(){
        ...
        Swal.fire({
            icon: 'error',
            title: 'Venta Anulada',
            text: 'No es posible reactivar una venta anulada',
