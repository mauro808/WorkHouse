            ...
            @foreach($ventas as $venta)
                <tr>
                    ...
                    <td>{{$usuario->nombreUsuario}}</td>
                        ...
                        <a class="btn btn-dark" href="{{ route('venta.show', $venta) }}" style="margin-left: 10px">
...
@if ($venta->Estado=="Activo")
    <a class="btn btn-danger" href="{{ route('venta.inhabilitacion', $venta->id) }}"style="margin-left: 10px; -moz-border-radius:18px; -webkit-border-radius:18px;">
...
@if ($venta->Estado=="Inactivo")
    <a type="submit" class="btn btn-success" href="{{ route('venta.habilitacion', $venta->id) }}"style="margin-left: 10px; -moz-border-radius:18px; -webkit-border-radius:18px;">
