 ...
 <div align="right">
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                        ...
                        @if ($categoria->estado=="Activo")
                            <a class="btn btn-danger" href="{{ route('categoria.inhabilitacion', $categoria->id) }}"style="margin-left: 10px">
...
Inhabilitar</a>
                        ...
                        @if ($categoria->estado=="Inactivo")
                            <a type="submit" class="btn btn-success" href="{{ route('categoria.habilitacion', $categoria->id) }}"style="margin-left: 10px">
