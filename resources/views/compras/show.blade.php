        ...
        <div class="col-12">
            <div class="card" style="background-color:#E5E8E8;">
                            ...
                            <table id="detalles" class="table">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th>
                                            <p align="right">$/{{number_format($compra->precioTotal,2)}}</p>
                                        </th>
                                    </tr>
                ...
                <div class="card-footer text-muted">
                    <a href="{{route('compras.index')}}" class="btn btn-dark float-right btn-lg"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-skip-backward-fill" viewBox="0 0 16 16">
